...
public class DateUtils {
    ...
    private static String addInteger(String date, int dateType, int amount) {
        ...
        if (dateStyle != null) {
            ...
            myDate = addInteger(myDate, Calendar.MONTH, amount);
     ...
     * @return 星期
     */
    public static Week getWeek(Long date) {
     ...
     * @author fy.zhang
     */
    public static String formatDuringEn(long mss) {
    ...
    /**
     * @param mss 要转换的毫秒数 (中文)
     * @return 该毫秒数转换为 * days * hours * minutes * seconds 后的格式
     * @author fy.zhang
     */
    public static String formatDuringCh(long mss) {
        long days = mss / (1000 * 60 * 60 * 24);
        long hours = (mss % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60);
        long minutes = (mss % (1000 * 60 * 60)) / (1000 * 60);
        long seconds = (mss % (1000 * 60)) / 1000;
     ...
     * @author fy.zhang
     */
    public static Date formatMssToDate(String mss) {
        return StringToDate(getDateFormat("yyyy-MM-dd hh:mm:ss").format(mss));
    }
    ...
    public static Date getStartDayOfWeekNo(int year, int weekNo) {
        Calendar calendar = getCalendarFormYear(year);
     ...
     * @return
     */
    public static Date removeAfterHour(Date date) {
        return removeAfterHour(date, "00:00:00");
    }
     ...
     *
     * @param date
     * @param timeSuffix 自定义后缀时间
     * @return
     */
    public static Date removeAfterHour(Date date, String timeSuffix) {
        String onlyDay = DateToString(date, "yyyy-MM-dd") + " " + timeSuffix;
        return StringToDate(onlyDay);
    }
     ...
     * @return
     */
    public static String getDiffDateStr(Long times) {
        int day = (int) (times / 1000 / 60 / 60 / 24);
        int dayRemainder = (int) (times - (day * 1000 * 60 * 60 * 24));

        int hour = (int) dayRemainder / 1000 / 60 / 60;
        int hourRemainder = (int) (dayRemainder - (hour * 1000 * 60 * 60));

        int minute = hourRemainder / 1000 / 60;
        int minuteRemainder = (int) (hourRemainder - (minute * 1000 * 60));
